...
--- @param dbg_type DbgType  the type entry (carries debug_type string)
--- @param target   DbgTarget  the target entry (relpath, alias, executable_type)
--- @param args     DbgArguments|nil  the argument preset, or nil for no args
--- @return table  a DAP configuration table suitable for dap.run()
